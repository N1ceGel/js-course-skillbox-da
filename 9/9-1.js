const getNumbersArray = (length) => {
  ...
  // Создаем массив, который состоит из половины чисел и затем объединяем его с самим собой
  return half.concat(half);
}

const mixArray = (array) => {
  // Используем метод sort с функцией сравнения, чтобы перемешать массив случайным образом
